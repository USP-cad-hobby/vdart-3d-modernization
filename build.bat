...
ifx -c vdart_forces_mod.f90   || goto :err
ifx -c vdart_blad_mod.f90     || goto :err
ifx -c vdart_start_mod.f90    || goto :err
ifx -c vdart_nethas_mod.f90   || goto :err
ifx -c vdart_vortex_mod.f90   || goto :err
ifx -c vdart_solver_mod.f90   || goto :err
ifx -c test_vortex.f90        || goto :err

echo Linking...
ifx vdart_kinds_mod.obj vdart_io_mod.obj vdart_biot_mod.obj vdart_aero_mod.obj vdart_state_mod.obj vdart_bsa_mod.obj vdart_wind_mod.obj vdart_flyt_mod.obj vdart_forces_mod.obj vdart_blad_mod.obj vdart_start_mod.obj vdart_nethas_mod.obj vdart_vortex_mod.obj vdart_solver_mod.obj test_vortex.obj -o test_vortex.exe || goto :err
